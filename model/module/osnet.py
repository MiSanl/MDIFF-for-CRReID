...
class OSBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels=512, IN=False, bottleneck_reduction=4, **kwargs):
...
def init_pretrained_weights(model, key=''):
    ...
    model_dir = '/home/bobo/H/zwc/CrossResolution/pretrained'
    try:
    ...
    cached_file = os.path.join(model_dir, filename)  # /home/dio/VSST2/zwc/CrossResolution/pretrained/osnet_x1_0_imagenet.pth

    if not os.path.exists(cached_file):
        # gdown.download(pretrained_urls[key], cached_file, quiet=True)
        print("ERROR!!! Pretrained model file not exists!!")
