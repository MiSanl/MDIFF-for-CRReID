...
__all__ = ['ResNet_IBN', 'resnet50', 'resnet101',
           'resnet152']
...
class Bottleneck_sr(nn.Module):  # 测试修改超分模型的效果
    expansion = 2
    def __init__(self, inplanes, planes, ibn=False, stride=1, downsample=None):
        super(Bottleneck_sr, self).__init__()
        mid_planes = inplanes // 4
...
def resnet152(last_stride, pretrained=False, **kwargs):
